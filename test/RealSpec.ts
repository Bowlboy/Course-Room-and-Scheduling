...
describe("RealSpec", function () {
    ...
    query9  = 'THIS IS AN INVALID QUERY';
    ...
    query14  = '{"WHERE":{"IS":{"courses_instructor":"*ello, william"}},"OPTIONS":{"COLUMNS":["courses_dept","courses_instructor", "courses_avg" ], "ORDER":"courses_avg", "FORM":"TABLE"}}';
