...
let responseNOT:string = '{"render":"TABLE","result":[{"courses_dept":"chem","courses_fail":266,"courses_uuid":"31192"},{"courses_dept":"chem","courses_fail":264,"courses_uuid":"31631"},{"courses_dept":"chem","courses_fail":250,"courses_uuid":"64755"},{"courses_dept":"chem","courses_fail":287,"courses_uuid":"70069"},{"courses_dept":"chem","courses_fail":260,"courses_uuid":"82096"},{"courses_dept":"chem","courses_fail":251,"courses_uuid":"89218"}]}';
...
let responseNoOrder = '{"render":"TABLE","result":[{"courses_dept":"cpsc","courses_instructor":"aiello, william","courses_avg":70.9},{"courses_dept":"cpsc","courses_instructor":"aiello, william","courses_avg":71.14},{"courses_dept":"cpsc","courses_instructor":"aiello, william","courses_avg":74},{"courses_dept":"cpsc","courses_instructor":"aiello, william","courses_avg":74.88},{"courses_dept":"cpsc","courses_instructor":"aiello, william","courses_avg":75.56},{"courses_dept":"cpsc","courses_instructor":"booth, kellogg","courses_avg":83.67},{"courses_dept":"isci","courses_instructor":"evans, robert;kellogg, jonathan","courses_avg":86.56},{"courses_dept":"isci","courses_instructor":"kellogg, jonathan","courses_avg":83},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":85.98},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":75.77},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":79.98},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":66.12},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":80.83},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":85.73},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":90.13},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":77.14},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":77.2},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":96.59},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":90.82},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":77.03},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":87.13},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":80.47},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":81.56},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":77.88},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":80.01},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":85.81},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":83.04},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":85.11},{"courses_dept":"mine","courses_instructor":"veiga, marcello","courses_avg":90.69},{"courses_dept":"phys","courses_instructor":"pavan, marcello","courses_avg":75.78},{"courses_dept":"phys","courses_instructor":"koster, evert;pavan, marcello;rieger, georg","courses_avg":74.94},{"courses_dept":"phys","courses_instructor":"pavan, marcello;rieger, georg","courses_avg":77.15},{"courses_dept":"phys","courses_instructor":"pavan, marcello;rieger, georg","courses_avg":78.82},{"courses_dept":"phys","courses_instructor":"pavan, marcello","courses_avg":70.55},{"courses_dept":"scie","courses_instructor":"booth, kellogg;oberg, gunilla","courses_avg":76.13}]}';
...
describe("RealSpec", function () {
    ...
    query5  = {"WHERE":{"NOT":{"LT":{"courses_fail": 250}}},"OPTIONS":{"COLUMNS":["courses_dept", "courses_fail", "courses_uuid"], "ORDER":"courses_uuid", "FORM":"TABLE"}};
    ...
    let query31: QueryRequest;
    query31 = {"WHERE":{"IS":{"courses_instructor":"*ello*"}},"OPTIONS":{"COLUMNS":["courses_dept","courses_instructor", "courses_avg" ], "FORM":"TABLE"}};
    ...
    it("Test NoOrder", function () {
        return myIR.performQuery(query31).then(function (response: InsightResponse) {
            // Log.test('The Response is: ' + JSON.stringify(response.body));
            var testerArray: String[] = [];
            expect(response.code).to.equal(200);
            expect(JSON.stringify(response.body)).to.equal(responseNoOrder);
        }).catch(function (err) {
            // Log.test('Error: ' + err);
            expect.fail();
        })
